...
class RescuePhotosAdapter(
    private val photos: List<PhotoItem>,
    private val onItemClick: (Int) -> Unit
) : RecyclerView.Adapter<RescuePhotosAdapter.PhotoViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PhotoViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_photo_rescue, parent, false)
